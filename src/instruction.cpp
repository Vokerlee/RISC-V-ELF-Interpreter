...
bool Instruction::decode(InstrValue instr)
{
    switch (instr & 0b1111111) // OPCODE
    {
        ...
        case 0b1101111: // JAL
        {
            ...
            immediate_ = (get_bits<31, 31>(instr) >> 11) + (get_bits<30, 21>(instr) >> 20) + 
        ...
        case 0b1100111: // JALR
        {
            ...
            if (funct3 == 0b000)
            {
                ...
                immediate_ = get_bits<31, 20>(instr) >> 20;
            }
            else
                return false;
        ...
        case 0b1100011: // BEQ / BNE / BLT / BGE / BLTU / BGEU
        {
            ...
            immediate_ = (get_bits<31, 31>(instr) >> 19) + (get_bits<30, 25>(instr) >> 20) +
        ...
        case 0b0100011: // SB / SH / SW
        {
            ...
            reg_src1_ = static_cast<RegId>(get_bits<19, 15>(instr) >> 15);
            reg_src2_ = static_cast<RegId>(get_bits<24, 20>(instr) >> 20);
            immediate_ = (get_bits<31, 25>(instr) >> 20) + (get_bits<11, 7>(instr) >> 7);
        ...
        i_type:
                    ...
                    break;
        r_type:
                    immediate_ = get_bits<24, 20>(instr) >> 20;
                    break;
                default:
                    return false;
            }
